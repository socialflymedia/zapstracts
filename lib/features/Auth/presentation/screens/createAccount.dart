          ...
          child: BlocConsumer<AuthBloc, AuthState>(
            listener: (context, state) {
              ...
              if (state is Authenticated) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("gazab")));
              }
              if (state is AuthError) {
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(state.message)));
              }
            ...
            builder: (context, state) {
                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 2.h),
                          Text("Create your account", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.sp)),
                          SizedBox(height: 8.h),
                          Padding(
                    ...
                    CustomGradientButton(
                      ...
                      onPressed: () {
                        ...
                        if (!state.agreed) {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please agree to terms.")));
                          return;
                        }
                        ...
                        bloc.add(SignUpRequested(email: email, password: password, name:username, phone:''));
              ...
              return Container(); // Return empty container if the state is not the expected one
            },
          ),
        ),
      ),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: isPassword
                ? IconButton(
              icon: Icon(obscureText ? Icons.visibility : Icons.visibility_off, size: 20.sp),
              onPressed: toggle,
            )
                : null,
